...
##Q3movie has the most run time

# for mov in movies:
#     print(mov.get("runtime"))
# for movie in movies:
#     movie["runtime"] = int(movie["runtime"])

# longest_movie = max(movies, key=lambda d: d.get("runtime"))
# print("The movie with the longest runtime is:", longest_movie.get("runtime"))      


# #Q4 minimum runtime

# shortest_movie = min(movies, key=lambda d: d.get("runtime"))
# print("The movie with the shortest runtime is:", shortest_movie.get("runtime")) 

#Q5 print the movie in id =126
# for movie in movies:
#     if movie.get("id") == 135:
#         print(movie.get("title"))            

#Q6 count 2015 released movies
# count={ }
# for mov in movies:
#     years=mov.get("year")
#     for year in years:
...
# runtime_filter=[m.get("title") for m in movies if int(m.get("runtime"))>150]
# print(runtime_filter)

#13. highest runtime

# highest_runtime=max(movies,key=lambda d:d.get("runtime"))
...
# value_key=[(v,k) for k,v in yearcount.items()]
# print(max(value_key))                  
